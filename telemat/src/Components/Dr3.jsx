            ...
            <form className="w-full max-w-md bg-transparent p-6 rounded-md space-y-8" onSubmit={handleSubmit}>
                ...
                <div className="space-y-2">
                            ...
                            >
                                ...
                                <option value="New York"> Registered Mail</option>
                                <option value="Los Angeles">Speed Post</option>
                                <option value="Chicago">Logistics Post</option>
                                <option value="Houston">Book Post</option>
                                <option value="San Francisco">Business Mail</option>
                            </select>
                        </div>
