...
const Dashboard2 = () => {
  ...
  return (
    <div className="h-screen bg-gradient-to-b from-gray-200 to-blue-100 p-4">
      ...
      {/* Rectangle Div */}
      <div
        className="h-16  bg-[rgba(30,45,52,1)] flex items-center justify-start px-8 rounded-full mt-20 relative"
      ...
      >
        ...
        {/* Ellipse 12 */}
        <div className="absolute w-20 h-20 -top-2 left-0 rounded-full bg-[#1e2d34] sm:w-16 sm:h-16 sm:-top-1 md:w-20 md:h-20 md:-top-2"></div>
      </div>
      ...
      <div className="grid grid-cols-3 gap-4 mt-5">
        ...
        <div className="flex">
          ...
          <div className="text-white p-4 rounded-lg mb-4 bg-[#3e4a56] w-48 h-[409px] relative left-12 top-0 gap-5 opacity-100 sm:w-40 sm:h-[350px] sm:left-8 md:w-48 md:h-[409px] md:left-12">
            {/* Overlapping div */}
            <div className="absolute top-0 left-0 w-48 h-10 bg-[#2A3644] flex items-center justify-center font-semibold text-white italic text-[16px] leading-[19.36px] rounded-t-[20px] z-20 sm:w-40 sm:h-8 sm:text-[14px] sm:leading-[18px] md:w-48 md:h-10 md:text-[16px] md:leading-[19.36px]">
              Overview Metrics
            </div>
            ...
            <div className="space-y-20">
              <div>
                <p>
                  ...
                  {dashboardData.overviewMetrics.parcelsInTransit}
                </p>
              </div>
              <div>
                <p>
                  Completed Deliveries Today:{" "}
                  {dashboardData.overviewMetrics.completedDeliveries}
                </p>
              </div>
              <div>
                <p>
                  Pending Deliveries:{" "}
                  {dashboardData.overviewMetrics.pendingDeliveries}
                </p>
              </div>
            </div>
          </div>
          ...
          <div className="flex flex-col">
            ...
            >
              ...
              >
                <p>
                  {dashboardData.capacityUtilization.capacityLeft}% capacity
        ...
        <div className="flex flex-col">
          ...
          >
            ...
            <p className="mt-12">
              ...
              {dashboardData.deliveryInfo.trackingNumber}
            </p>
            <p className="mt-5">
              ⛟ Pickup: {dashboardData.deliveryInfo.pickupLocation}
            </p>
            <p className="mt-5">
              📞 Driver/ Vehicle Assigned :{" "}
              {dashboardData.deliveryInfo.contactPerson}
            </p>
            <p className="mt-5">
              📍 Destination:{" "}
              <span>{dashboardData.deliveryInfo.destination}</span>
            </p>
          </div>
